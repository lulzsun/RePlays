    ...
    <div className='flex flex-col gap-2 font-medium text-base pb-7'>
      ...
      <div className='flex flex-col'>
        ...
        <input
          ...
          type='email'
          defaultValue={settings === undefined ? '' : settings.rePlaysSettings.email}
          onBlur={(e) => {
            if (settings !== undefined) settings.rePlaysSettings.email = e.target.value;
            updateSettings();
          }}
        />
      </div>
      <div className='flex flex-col'>
        ...
        <input
          className={`inline-flex align-middle justify-center w-64 h-full px-4 py-2 text-sm font-medium leading-5 text-gray-700 transition duration-150 ease-in-out bg-white border border-gray-300 rounded-md hover:text-gray-700 focus:outline-none focus:border-blue-300 focus:shadow-outline-blue active:bg-gray-50 active:text-gray-800`}
          type='password'
          defaultValue={settings === undefined ? '' : settings.rePlaysSettings.password}
          onFocus={(e) => {
            e.target.value = '';
          }}
          onBlur={(e) => {
            if (settings !== undefined) settings.rePlaysSettings.password = e.target.value;
            updateSettings();
          }}
        />
      </div>
    ...
    <div className='flex flex-col gap-2 font-medium text-base pb-7'>
      ...
      <div className='flex flex-col'>
        ...
        <input
          className={`inline-flex align-middle justify-center w-64 h-full px-4 py-2 text-sm font-medium leading-5 text-gray-700 transition duration-150 ease-in-out bg-white border border-gray-300 rounded-md hover:text-gray-700 focus:outline-none focus:border-blue-300 focus:shadow-outline-blue active:bg-gray-50 active:text-gray-800`}
          type='email'
          defaultValue={settings === undefined ? '' : settings.streamableSettings.email}
          onBlur={(e) => {
            if (settings !== undefined) settings.streamableSettings.email = e.target.value;
            updateSettings();
          }}
        />
      </div>
      <div className='flex flex-col'>
        ...
        <input
          className={`inline-flex align-middle justify-center w-64 h-full px-4 py-2 text-sm font-medium leading-5 text-gray-700 transition duration-150 ease-in-out bg-white border border-gray-300 rounded-md hover:text-gray-700 focus:outline-none focus:border-blue-300 focus:shadow-outline-blue active:bg-gray-50 active:text-gray-800`}
          type='password'
          defaultValue={settings === undefined ? '' : settings.streamableSettings.password}
          onFocus={(e) => {
            e.target.value = '';
          }}
          onBlur={(e) => {
            if (settings !== undefined) settings.streamableSettings.password = e.target.value;
            updateSettings();
          }}
        />
      </div>
    ...
    <div className='flex flex-col gap-2 font-medium text-base pb-7'>
      ...
      <div className='flex flex-col'>
        <div className='flex flex-row'>
          <DirectoryBrowser
            id='localFolderDir'
            path={settings === undefined ? undefined : settings.localFolderSettings.dir}
          />
          <p>&nbsp;&nbsp;</p>
          <Button
            ...
            onClick={(e) => {
              postMessage(
                'ShowFolder',
                settings === undefined ? 'C:\\' : settings.localFolderSettings.dir,
              );
            }}
          />
        </div>
    ...
    <div className='flex flex-col gap-2 font-medium text-base'>
      ...
      <div className='flex flex-col'>
        ...
        <input
          className={`inline-flex align-middle justify-center w-64 h-full px-4 py-2 text-sm font-medium leading-5 text-gray-700 transition duration-150 ease-in-out bg-white border border-gray-300 rounded-md hover:text-gray-700 focus:outline-none focus:border-blue-300 focus:shadow-outline-blue active:bg-gray-50 active:text-gray-800`}
          type='email'
          defaultValue={settings === undefined ? '' : settings.customUploaderSettings.url}
          onBlur={(e) => {
            if (settings !== undefined) settings.customUploaderSettings.url = e.target.value;
            updateSettings();
          }}
        />
      </div>
      <div className='flex flex-col'>
        ...
        <DropDownMenu
          text={settings === undefined ? 'POST' : settings!.customUploaderSettings.method}
          width={'auto'}
          zIndex={52}
          items={[
            {
      ...
      <div className='flex flex-col'>
        ...
        <DropDownMenu
          text={settings === undefined ? 'JSON' : settings!.customUploaderSettings.responseType}
          width={'auto'}
          zIndex={52}
          items={[
            {
      ...
      <div className='flex flex-col'>
        ...
        <input
          className={`inline-flex align-middle justify-center w-64 h-full px-4 py-2 text-sm font-medium leading-5 text-gray-700 transition duration-150 ease-in-out bg-white border border-gray-300 rounded-md hover:text-gray-700 focus:outline-none focus:border-blue-300 focus:shadow-outline-blue active:bg-gray-50 active:text-gray-800`}
          type='text'
          defaultValue={settings === undefined ? '' : settings.customUploaderSettings.responsePath}
          onBlur={(e) => {
            if (settings !== undefined)
