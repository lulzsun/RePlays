...
export const Detection: React.FC<Props> = ({ settings, updateSettings }) => {
  ...
  return (
    <div className='flex flex-col gap-2 font-medium text-base pb-7'>
      ...
      <span className='font-normal text-sm pb-2'>{t('settingsDetectionItem02')}</span>
      <span className='text-gray-700 dark:text-gray-400'>{t('settingsDetectionItem03')}</span>
      <span className='font-normal text-sm'>{t('settingsDetectionItem04')}</span>
      <Button
      ...
      <span className='text-gray-700 dark:text-gray-400'>{t('settingsDetectionItem06')}</span>
      <span className='font-normal text-sm'>{t('settingsDetectionItem07')}</span>
      <div className='flex flex-col gap-2'>
        {settings !== undefined &&
