...
export const About: React.FC<Props> = ({}) => {
    ...
    <div className="flex flex-col gap-2 font-medium text-base pb-7"> 
      ...
      onClick={(e) => {postMessage("ShowFolder", "https://github.com/lulzsun/RePlays")}}>
        ...
        <span className="font-normal text-sm">This version is currently being maintained by lulzsun! Thanks for the continued support! 😍🤟</span>
      </div>

      <span className="text-gray-700 dark:text-gray-400 mt-2">RePlays Pages</span>
      ...
      <span className="text-gray-700 dark:text-gray-400 mt-2">RePlays Team</span>
      ...
      <span className="text-gray-700 dark:text-gray-400 mt-2">External libraries</span>
      ...
      <span className="font-normal text-sm">Tailwind:
        <a className="cursor-pointer underline pl-2" onClick={(e) => {postMessage("ShowFolder", "https://tailwindcss.com")}}>https://tailwindcss.com</a>
      </span>
      <span className="font-normal text-sm">NHotkey:
        <a className="cursor-pointer underline pl-2" onClick={(e) => {postMessage("ShowFolder", "https://github.com/thomaslevesque/NHotkey")}}>https://github.com/thomaslevesque/NHotkey</a>
      </span>

      <span className="text-gray-700 dark:text-gray-400 mt-2">License</span>
