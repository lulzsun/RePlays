        ...
        <div className="flex flex-row gap-2">
          ...
          <Button
            ...
            onClick={(e) => {
              postMessage(
                "ShowFolder",
                settings === undefined ? "C:\\" : settings.videoSaveDir
              );
            }}
          />
        </div>
        ...
        <div className="flex flex-row gap-2">
          ...
          <Button
            ...
            onClick={(e) => {
              postMessage(
                "ShowFolder",
                settings === undefined ? "C:\\" : settings.tempSaveDir
              );
            }}
          />
        </div>
      ...
      <div>
        <label className="inline-flex items-center">
          <input
            ...
            defaultChecked={
              settings === undefined ? false : settings.autoManageSpace
            }
            onChange={(e) => {
