            ...
            <Switch>
              <Route exact path="/settings/general">
                <General
                  ...
                  settings={userSettings?.generalSettings}
                />
              </Route>
              <Route exact path="/settings/capture">
                <Capture
                  updateSettings={updateSettings}
                  settings={userSettings?.captureSettings}
                />
              </Route>
              ...
              <Route exact path="/settings/keybinds">
                <KeyBind
                  updateSettings={updateSettings}
                  settings={userSettings?.keybindSettings}
                />
              </Route>
              <Route exact path="/settings/upload">
                <Upload
                  updateSettings={updateSettings}
                  settings={userSettings?.uploadSettings}
                />
              </Route>
              <Route exact path="/settings/storage">
                <Storage
                  updateSettings={updateSettings}
                  settings={userSettings?.storageSettings}
                />
              </Route>
