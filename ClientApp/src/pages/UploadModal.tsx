      ...
      <div className="flex flex-col gap-2">
        ...
        <div className="flex flex-col">
          ...
          <div className="group relative w-full">
            <svg className="absolute w-5 h-5 -ml-8 mt-2 top-px left-full text-gray-700 group-hover:text-gray-500 cursor-pointer pointer-events-none" viewBox="0 0 20 20" fill="currentColor">
            ...
            name="ddm" id="ddm" defaultValue={destination} onChange={(e) => setDestination(e.target.value)}>
