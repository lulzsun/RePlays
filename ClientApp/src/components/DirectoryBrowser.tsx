...
export const DirectoryBrowser: React.FC<Props> = ({ id = '', path = 'C:/FakePath', onClick }) => {
  return (
    <button
      className={`relative inline-flex justify-center w-full h-full px-4 py-2 text-sm font-medium leading-5 text-gray-600 transition duration-150 ease-in-out bg-gray-100 border border-gray-300 rounded-md hover:text-gray-700 focus:outline-none focus:border-blue-300 focus:shadow-outline-blue active:bg-gray-50 active:text-gray-800`}
      type='button'
      onClick={(e) => {
