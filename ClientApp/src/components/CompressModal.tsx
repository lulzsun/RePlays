  ...
  return (
    <div className="flex flex-row gap-6">
      <img
        ...
        alt={"video_thumbnail_placeholder.png"}
        src={thumb}
      />
          ...
          <div className="group relative w-full">
            ...
            >
              <option value="ultrafast">
                {t("componentCompressModalItem02")}
              </option>
              <option value="veryfast">
                {t("componentCompressModalItem03")}
              </option>
              ...
              <option value="slower">
                {t("componentCompressModalItem07")}
              </option>
              <option value="veryslow">
                {t("componentCompressModalItem08")}
              </option>
            </select>
          </div>
        </div>
