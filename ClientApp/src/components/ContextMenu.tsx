...
export const ContextMenu: React.FC<Props> = ({items, position={x: 0, y: 0}}) => {
    ...
    absolute transform -translate-y-full left-0 origin-bottom-left w-auto border divide-y divide-gray-100 rounded-md shadow-lg outline-none" aria-labelledby="headlessui-menu-button-1" id="headlessui-menu-items-117" role="menu">
