  ...
  return (
    <Router>
      <div className="relative min-h-screen lg:flex">
        <div className="sidebar bg-blue-800 text-blue-100 w-60 space-y-6 py-7 px-2 absolute inset-y-0 left-0 transform -translate-x-full lg:relative lg:translate-x-0 transition duration-200 ease-in-out">
          <div className="text-white flex items-center space-x-2 px-4">
            ...
            <span className="text-2xl font-extrabold">RePlays</span>
          </div>
          <nav>
            <Link to="/" className="flex items-center block py-2.5 px-4 rounded transition duration-200 hover:bg-blue-700 hover:text-white">
              ...
              <span className="pl-2">Sessions</span>
            </Link>
            <Link to="/clips" className="flex items-center block py-2.5 px-4 rounded transition duration-200 hover:bg-blue-700 hover:text-white">
              ...
              <span className="pl-2">Clips</span>
            </Link>
            <Link to="/uploads" className="flex items-center block py-2.5 px-4 rounded transition duration-200 hover:bg-blue-700 hover:text-white">
              ...
              <span className="pl-2">Uploads</span>
            </Link>
        ...
        <div className="flex flex-col h-screen w-full text-2xl font-bold">
          ...
          <div className="flex-auto overflow-auto h-full p-10">
            <Switch>
              <Route exact path="/">         <Sessions/></Route>
