        ...
        <div className="relative min-h-screen lg:flex">
          ...
          <div className="sidebar bg-blue-800 text-blue-100 w-auto py-2 px-2 absolute inset-y-0 left-0 transform -translate-x-full lg:relative lg:translate-x-0 transition duration-200 ease-in-out" style={{zIndex: 999}}>
            ...
            <div style={{height: "50px"}} className="flex flex-row items-center justify-center w-full">
              <div title="Hide/Show Notifications" className="p-2 px-4 flex items-center rounded transition duration-200 hover:bg-blue-700 hover:text-white cursor-pointer">
              ...
              <div title="Recent Links" className="p-2 px-4 flex items-center rounded transition duration-200 hover:bg-blue-700 hover:text-white cursor-pointer"
              onClick={(e) => {
              ...
              {/* <div className="group relative">
                ...
                <select className={`w-14 h-10 flex items-center rounded transition duration-200 bg-transparent text-transparent group-hover:bg-blue-700 focus:outline-none cursor-pointer`}
