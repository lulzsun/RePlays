...
namespace RePlays.Uploaders {
    public class RePlaysUploader : BaseUploader {
        ...
        public override async Task<string> Upload(string id, string title, string file, string game, bool makePublic) {
            try {
                using (var httpClient = new HttpClient()) {
                    ...
                    using (var formDataContent = new MultipartFormDataContent()) {
                        ...
                        formDataContent.Add(makePublicContent, "public");
                        Logger.WriteLine(formDataContent.ToString());
